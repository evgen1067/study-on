...
class LessonControllerTest extends AbstractTest
{
    ...
    public function testLessonCreatingWithEmptyContent(): void
    {
        ...
        $client->submit($lessonCreatingForm);
        self::assertSelectorTextContains('.invalid-feedback.d-block', 'Содержимое урока не может быть пустым');
    }
    ...
    public function testLessonCreatingWithEmptyNumber(): void
    {
        ...
        $client->submit($lessonCreatingForm);
        self::assertSelectorTextContains('.invalid-feedback.d-block', 'Порядковый номер урока не может быть пустым');
    }
    ...
    public function testLessonCreatingWithTooLongName(): void
    {
        ...
        $client->submit($lessonCreatingForm);
        self::assertSelectorTextContains('.invalid-feedback.d-block', 'Название урока должно быть не более 255 символов');
    }
    ...
    public function testLessonCreatingWithMoreNumber(): void
    {
        ...
        $client->submit($lessonCreatingForm);
        self::assertSelectorTextContains('.invalid-feedback.d-block', 'Значение поля должно быть в пределах от 1 до 10000');
    }
    ...
    public function testLessonCreatingWithNumberIsNotNumber(): void
    {
        ...
        $client->submit($lessonCreatingForm);
        self::assertSelectorTextContains('.invalid-feedback.d-block', 'Пожалуйста, введите номер.');
    }
